...
def show_gen_image(results_folder_path, image_prefix, depth_image, gen_image,z_corr, iters):
    ...
    plt.gca().yaxis.set_major_formatter(plt.FormatStrFormatter('%.1f'))
    plt.subplots_adjust(wspace=0.1,hspace=0.1)
    im0 = axs[0].imshow(gen_img, vmin=vmin, vmax=vmax)
    # im0 = axs[0].imshow(z_corr, vmin=0, vmax=5)
    # cbar = fig.colorbar(im0, ax=axs[0])
    # cbar.ax.tick_params(labelsize=16)
    # cbar.ax.set_ylabel('Depth [m]',labelpad=7, rotation=90,fontsize=14)
    ...
    # axs[0,0].set_xlabel('Column number',fontsize=14)
    # axs[0, 0].set_ylabel('Row number',labelpad=0,fontsize=14)
    axs[0].hlines([96], 0, 127, "red", linestyles='dashed',linewidth = 4)
    # axs[0, 0].hlines([64], 0, 128, "green", linestyles='dashed',linewidth = 4)
    # axs[0, 0].hlines([96], 0, 128, "blue", linestyles='dashed',linewidth = 4)
    axs[0].set_xlim([0, 127])
    axs[0].set_xticks([])
    axs[0].set_yticks([])
    axs[1].plot(z_corr[128*3 // 4, :], label="old")
    # axs[1].plot(z_corr[128 // 4, :], label=title)
    axs[1].plot(gen_img[128*3 // 4, :], label=title)
    # axs[1].plot(gen_img[128 // 4, :], label="deep_learning_depth")
    axs[1].legend(fontsize=14)
    # axs[1].set_title('32th row depth (red line)',fontsize=18)
    axs[1].set_xlabel('Column number', fontsize=18)
    ...
    # ax2 = axs[1].twinx()
    # ax2.set_ylabel('32th row depth (red line)',fontsize=18)
    fig.savefig(os.path.join(results_folder_path, 'row32th_4'+title+'_'+image_prefix+'.png'))
    # plt.show()
    plt.close()
    ...
    im0 = axs[0].imshow(z_corr, vmin=vmin, vmax=vmax)
    # cbar = fig.colorbar(im0, ax=axs[0])
    # cbar.ax.tick_params(labelsize=16)
    # cbar.ax.set_ylabel('Depth [m]',labelpad=7, rotation=90,fontsize=14)
    # axs[0].set_title('L1 + adv',fontsize=18)
    axs[0].set_title('old method', fontsize=28)
    # axs[0,0].set_xlabel('Column number',fontsize=14)
    # axs[0, 0].set_ylabel('Row number',labelpad=0,fontsize=14)
    axs[0].hlines([32], 0, 127, "red", linestyles='dashed',linewidth = 4)
    # axs[0, 0].hlines([64], 0, 128, "green", linestyles='dashed',linewidth = 4)
    ...
    # axs[1].plot(z_corr[128 // 4, :], label=title)
    axs[1].plot(z_corr[128 // 4, :], label='old')
    # axs[1].plot(gen_img[128 // 4, :], label="deep_learning_depth")
    axs[1].legend(fontsize=14)
    # axs[1].set_title('32th row depth (red line)',fontsize=18)
    axs[1].set_xlabel('Column number', fontsize=18)
    ...
    axs[0].set_xticks([])
    axs[0].set_yticks([])
    im0 = axs[1].imshow(np.abs(gen_img-depth_img), vmin=diff_vmin, vmax=diff_vmax)
    ...
    axs[0].set_xticks([])
    axs[0].set_yticks([])
    im0 = axs[1].imshow(np.abs(z_corr-depth_img), vmin=diff_vmin, vmax=diff_vmax)
    axs[1].set_xlim([0, 127])
    axs[1].set_xticks([])
    axs[1].set_yticks([])
    ...
    # plt.subplots_adjust(wspace=0.1,hspace=0.1)
    # im0 = axs[0].imshow(gen_img, vmin=0, vmax=5)
    im0 = axs.imshow(depth_img, vmin=0, vmax=5)
    ...
    # cbar.ax.set_ylabel('Depth [m]',labelpad=7, rotation=90,fontsize=14)
    # axs[0].set_title('L1 + adv',fontsize=18)
    axs[0].set_title('Phase', fontsize=18)
    # axs[0,0].set_xlabel('Column number',fontsize=14)
    # axs[0, 0].set_ylabel('Row number',labelpad=0,fontsize=14)
    axs[0].hlines([32], 0, 128, "red", linestyles='dashed',linewidth = 4)
    ...
    axs[1].plot(depth_img[128 // 4, :], label="ground_truth")
    axs[1].plot(z_corr[128 // 4, :], label="phase_depth")
    # axs[1].plot(gen_img[128 // 4, :], label="deep_learning_depth")
...
if __name__ == '__main__':
    ...
    test_dataset_folder = r"datasets/panaToF-test3"
    eval_folder = 'eval'
    nameprefix = f'test_panaToF3-{title}'
